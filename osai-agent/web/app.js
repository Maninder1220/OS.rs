...
async function askReasoning() {
  ...
  $("reasonOutput").innerHTML = item(
    "Working",
    aiRequested
      ? "Rust is matching server signals first. AI will refine only if the reasoning layer is ready."
      : "Rust is matching your question to server scan signals. AI is off."
  );
